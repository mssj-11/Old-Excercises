...
public class Cliente {
    ...
    private static final String IP = "192.168.5.105"; // Puedes cambiar a localhost
    private static final int PUERTO = 2345; //Nuestro puerto del servidor
