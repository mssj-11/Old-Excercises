 ...
 * @author Nuvia
 */
public class VigenereEN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("METODO VIGENERE ENCRIPTAR");
    ...
    public static String  Cript(String T, String pal){
        String TC ="";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VigenereEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VigenereEN().setVisible(true);
            }
        });
    }
