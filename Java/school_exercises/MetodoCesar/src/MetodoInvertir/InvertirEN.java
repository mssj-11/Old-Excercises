 ...
 * @author Nuvia
 */
public class InvertirEN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("METODO INVERTIR ENCRIPTAR");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENES/1386335828_folder_encrypted.png"))); // NOI18N
...
//System.out.println(sCadenaInvertida);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvertirEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvertirEN().setVisible(true);
            }
        });
    }
