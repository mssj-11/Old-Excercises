...
public class DesEncriptar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("METODO CESAR TRES POSICIONES");
        ...
        btnGuardar4.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        btnGuardar4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENES/desencriptar.png"))); // NOI18N
        btnGuardar4.setText("Desencriptar");
...
public String ValidarDatos() {//Metodo para comprobar que los datos esten completos
    ...
    private void btnGuardar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar4ActionPerformed
        ...
        if (ValidarDatos().equals("")) {//Si el medoto ValidarDatos devuelve "", es decir, nada es porque
            ...
            try{
                String mensaje=this.txtTexto.getText();//Obtiene el valor de la caja de texto nombre
                ...
                txtTexto.setText(desencriptado);
                ...
                DesEncriptar em = new DesEncriptar();
            }
