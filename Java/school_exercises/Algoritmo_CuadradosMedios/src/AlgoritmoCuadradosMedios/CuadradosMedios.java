 ...
 */
package AlgoritmoCuadradosMedios;
...
class CuadradosMedios extends JFrame {
    ...
    public CuadradosMedios() {
        ...
        ImageIcon img = new ImageIcon ("/ImageneS/sold.gif");
        ...
        l1 = new JLabel(" Cuadrados Medios");
        ...
        t1.setBorder(BorderFactory.createMatteBorder(2, 1, 2, 1, Color.BLACK));
        ...
        t2.setBorder(BorderFactory.createMatteBorder(2, 1, 2, 1, Color.BLACK));
        ...
        a1.setBorder(BorderFactory.createMatteBorder(3, 1, 3, 1, Color.BLACK));
        ...
        a2.setBorder(BorderFactory.createMatteBorder(3, 1, 3, 1, Color.BLACK));
        ...
        a3.setBorder(BorderFactory.createMatteBorder(3, 1, 3, 1, Color.BLACK));
            ...
            if (evento.getSource() == b1) {
                ...
                if (t2.getText().equals("")) {
                    ...
                    try {
                        ...
                        if (n <= 999) {
                            JOptionPane.showMessageDialog(null, "El valor de Xi debe ser de 4 o + digitos");
                            t1.setText("");
                        } else {
