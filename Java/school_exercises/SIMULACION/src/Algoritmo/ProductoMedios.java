...
class ProductoMedios extends JFrame {
    ...
    public ProductoMedios() {
        ...
        l1 = new JLabel(" Producto de Medios");
        ...
        t3.setBorder(BorderFactory.createMatteBorder(2, 1, 2, 1, Color.BLACK));
