...
public class Aplicacion {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        do {
            ...
            System.out.println("\033[31m 5.Salir");
            System.out.println("\033[34m*******************");
            opcion = leo.nextInt();
            switch (opcion) {
    ...
    public static void insertarProcedimiento() throws SQLException {
        ...
        try {
            ...
            longitud = leo.next();
            System.out.println("Introduzca el Nombre de Campo");
            nombreCam = leo.next();
    ...
    public static void editarProcedimiento() throws SQLException {
        ...
        try {
            ...
            longitud = leo.next();
            System.out.println("Introduzca un Nuevo Campo");
            nombreCam = leo.next();
            System.out.println("Introduzca una Descripcion");
            descripcion = leo.next();
            ...
            conectar.commit();
            System.out.println("Actualizado con exito :v");
