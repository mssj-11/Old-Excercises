...
public class trans_colum_clav {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\033[31m    SEGURIDAD INFORMATICA     ");
        System.out.println("\033[31m     MICHAEL SALGADO SOTERO     ");
        System.out.println("\033[31m    Cifrando por columnas con clave     ");
